...
namespace DMT.Modules.WallpaperChanger
{
	...
	public class ProviderFactory : IProviderFactory
	{
		...
		public ProviderFactory(ISettingsService settingsService, ILogger logger)
		{
		...
		void CreatePlugins()
		{
			...
			_plugins.Add(new DMT.Modules.WallpaperChanger.Plugins.LocalDisk.LocalDiskPlugin(_logger));
			_plugins.Add(new DMT.Modules.WallpaperChanger.Plugins.List.ListPlugin(_logger));
