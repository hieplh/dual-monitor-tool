...
namespace DMT.Modules.WallpaperChanger.Plugins.List
{
	...
	/// <summary>
	/// Plugin for images from a list of filenames or URLs
	/// </summary>
	public class ListPlugin : IDWC_Plugin
	{
		public const string PluginVersion = "0.0";
		const string MyPluginName = "List";

		ILogger _logger;

		public ListPlugin(ILogger logger)
		{
			_logger = logger;
		}
		...
		public static Image PluginImage
		{
			get
			{
				return Properties.Resources.ListPlugin;
			}
		}
		...
		{
			return new ListProvider(config, _logger);
		}
	}
}
