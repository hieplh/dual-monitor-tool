namespace DMT.Modules.General
{
	partial class GeneralMonitorsOptionsPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.contextMenuStripChangeContrast = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.toolStripMenuItemChangeContrast = new System.Windows.Forms.ToolStripMenuItem();
			((System.ComponentModel.ISupportInitialize)(this.dataGridView)).BeginInit();
			this.contextMenuStripChangePrimary.SuspendLayout();
			this.contextMenuStripChangeBrightness.SuspendLayout();
			this.contextMenuStripChangeContrast.SuspendLayout();
			this.SuspendLayout();
			// 
			// dataGridView
			// 
			...
			// 
			// contextMenuStripChangeContrast
			// 
			this.contextMenuStripChangeContrast.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.toolStripMenuItemChangeContrast});
			this.contextMenuStripChangeContrast.Name = "contextMenuStripChangeContrast";
			this.contextMenuStripChangeContrast.Size = new System.Drawing.Size(208, 48);
			// 
			// toolStripMenuItemChangeContrast
			// 
			this.toolStripMenuItemChangeContrast.Name = "toolStripMenuItemChangeContrast";
			this.toolStripMenuItemChangeContrast.Size = new System.Drawing.Size(207, 22);
			this.toolStripMenuItemChangeContrast.Text = "Change monitor contrast";
			this.toolStripMenuItemChangeContrast.Click += new System.EventHandler(this.toolStripMenuItemChangeContrast_Click);
			// 
			...
			this.contextMenuStripChangeContrast.ResumeLayout(false);
		...
		private System.Windows.Forms.ContextMenuStrip contextMenuStripChangeContrast;
		private System.Windows.Forms.ToolStripMenuItem toolStripMenuItemChangeContrast;
